...
### 4.1 SMS transactionnels (Clients)

Code de vérification mobile ; alerte lorsqu'un Artisan demande le contact. Peuvent ne pas comporter de clause STOP afin d'éviter un désabonnement involontaire après un code ou une alerte.

### 4.2 Marketing SMS (prospection B2B)

L'Éditeur peut envoyer des SMS d'information / invitation à des **entreprises du bâtiment** (Professionnels non inscrits / prospects), à partir de **sources publiques** et/ou d'un enrichissement (SIRET, NAF, ville, téléphone), pour signaler des chantiers ou inviter à s'inscrire sur la Plateforme.

**Base légale :** intérêt légitime (développement B2B), sous réserve du droit d'opposition.

- Déclenchement **manuel** ou **automatique** lorsqu'une demande Client est validée et publiée comme offre, dans la limite des places de contact (notamment 5 Artisans max. par offre)
- Campagnes éventuellement découpées en **lots quotidiens** jusqu'à l'objectif de mise en relation
- Transmission via **OVH SMS** ; dès soumission effective au prestataire, prise en charge pour livraison (sous réserve du réseau). Une phase de préparation / validation interne peut précéder l'envoi réel
- Mention **STOP** sur chaque message marketing ; opposition enregistrée et respectée
- Fenêtre indicative des SMS commerciaux : lundi–samedi, 8h–20h (heure de Paris)
...
Clients/Artisans (mesure nécessaire, notamment après déblocage), sous-traitants (OVH hébergement et SMS, email, Stripe, Google Analytics si consentement), autorités sur réquisition. Pas de vente de données.

## 6. Transferts hors UE

Hébergement principal France (OVH). Certains sous-traitants peuvent impliquer hors UE avec garanties appropriées.
...
Mesures raisonnables (accès, hash mots de passe, hébergement, hash des codes OTP). Aucun système infaillible.
...
Site non destiné aux moins de 15 ans.
