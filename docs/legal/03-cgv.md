...
Ventes B2B : pas de droit de rétractation consommateur. Si consommateur exceptionnel : perte possible du droit pour contenu numérique fourni immédiatement avec accord.
...
Version en vigueur au moment du paiement.

## 12. Droit applicable

Droit français. Tribunaux du siège du Vendeur (B2B), sous réserve d'ordre public.
