...
# Applique le verrouillage IP Nginx sur dev.nord-artisan-pro.com.
...
if [ ${#IPS[@]} -eq 0 ]; then
  echo "ERREUR: aucune IP autorisée pour dev.nord-artisan-pro.com"
...
echo "==> [deprecated] Verrouillage IP dev.nord-artisan-pro.com → ${IPS[*]}"
